...
def check_redis(host,port,passwd,server_id,tags):
    try:
        ...
        func.update_db_status_init(server_id,role_new,redis_version,host,port,tags)
        ...
        try:
            connect=0
            sql="replace into redis_status(server_id,host,port,tags,connect) values(%s,%s,%s,%s,%s)"
